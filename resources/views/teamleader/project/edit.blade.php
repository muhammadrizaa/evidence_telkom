<x-teamleader-layout>
    ...
    <div class="card">
        <div class="card-header">
            <i class="fa-solid fa-edit" style="color:#dc2626; margin-right:8px;"></i>Edit Project
        </div>
            ...
            <div class="form-group">
                ...
                <select name="tematik_id" required>
                    ...
                    @foreach($tematiKs as $tematik)
                        <option value="{{ $tematik->id }}" {{ old('tematik_id', $project->tematik_id) == $tematik->id ? 'selected' : '' }}>
            ...
            <div class="form-group">
                ...
                <select name="waspang_id" required>
                    ...
                    @foreach($waspangs as $waspang)
                        <option value="{{ $waspang->id }}" {{ old('waspang_id', $project->waspang_id) == $waspang->id ? 'selected' : '' }}>
