<x-teamleader-layout>
    ...
    <div class="card">
        <div class="card-header"><i class="fa-solid fa-edit" style="color:#dc2626; margin-right:8px;"></i>Edit Assignment</div>
        <form method="POST" action="{{ route('teamleader.assignment.update', $assignment->id) }}">
            ...
            <div class="form-group">
                ...
                <select name="tematik_id" required>
                    ...
                    @foreach ($tematiKs as $tematik)
                        <option value="{{ $tematik->id }}" {{ old('tematik_id', $assignment->tematik_id) == $tematik->id ? 'selected' : '' }}>
            ...
            <div class="form-group">
                ...
                <select name="po_id" required>
                    ...
                    @foreach ($po_list as $po)
                        <option value="{{ $po->id }}" {{ old('po_id', $assignment->po_id) == $po->id ? 'selected' : '' }}>
                            {{ $po->no_po }}
                        </option>
                    @endforeach
                </select>
            ...
            <div class="form-row">
                ...
                <div class="form-group">
                    ...
                    <input type="date" name="deadline" value="{{ old('deadline', $assignment->deadline) }}" required>
