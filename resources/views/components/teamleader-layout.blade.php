...
<head>
    ...
    <title>Team Leader Panel | {{ config('app.name', 'Laravel') }}</title>
...
<body>
    <div class="sidebar">
        ...
        <a href="{{ route('teamleader.dashboard') }}"
           class="{{ request()->routeIs('teamleader.dashboard') ? 'active' : '' }}">
            <i class="fa-solid fa-tachometer-alt"></i> Dashboard
        </a>

        <a href="{{ route('teamleader.project.index') }}"
           class="{{ request()->routeIs('teamleader.project.*') ? 'active' : '' }}">
            <i class="fa-solid fa-diagram-project"></i> Project
        </a>

        <a href="{{ route('teamleader.assignment.index') }}"
           class="{{ request()->routeIs('teamleader.assignment.*') ? 'active' : '' }}">
            <i class="fa-solid fa-users-gear"></i> Assignment
        </a>
