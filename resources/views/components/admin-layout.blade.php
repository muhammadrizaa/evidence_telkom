...
<body>
    ...
    <div class="sidebar" id="sidebar">
        ...
        <a href="{{ route('admin.kelolauser.index') }}" class="{{ request()->routeIs('admin.kelolauser.*') ? 'active' : '' }}"><i class="fa-solid fa-users"></i> Data User</a>
        <a href="{{ route('admin.waspang.index') }}" class="{{ request()->routeIs('admin.waspang.*') ? 'active' : '' }}"><i class="fa-solid fa-user-tie"></i> Data Waspang</a>
        <a href="{{ route('admin.tematik.index') }}" class="{{ request()->routeIs('admin.tematik.*') ? 'active' : '' }}"><i class="fa-solid fa-tags"></i> Kelola Tematik</a>
        <a href="{{ route('admin.po.index') }}" class="{{ request()->routeIs('admin.po.*') ? 'active' : '' }}"><i class="fa-solid fa-money-check-dollar"></i> Data Purchase Order</a>
